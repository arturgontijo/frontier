...
pub fn spawn_tracing_tasks<B, C, BE>(
	rpc_config: &crate::cli::EvmTracingConfiguration,
...
{
	let permit_pool = Arc::new(Semaphore::new(rpc_config.tracing_max_permits as usize));
	...
	let (trace_filter_task, trace_filter_requester) =
		if rpc_config.ethapi.contains(&EthApiCmd::Trace) {
			let (trace_filter_task, trace_filter_requester) = CacheTask::create(
				...
				core::time::Duration::from_secs(rpc_config.tracing_cache_duration),
